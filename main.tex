...
\title[Challenges in Mnfg/QC and faults detection using PCA]{Challenges in Manufacturing/Quality Control and Detection of Faults in Chain of Manufacturing by Principle Components Analysis}

% A subtitle is optional and this may be deleted
\subtitle{(Orientation and Size)}
