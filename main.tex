...
\title[Challenges in Mnfg/QC and faults detection using PCA]{Challenges in Manufacturing/Quality Control and Detection of Faults in Chain Manufacturing by Principle Components Analysis}
